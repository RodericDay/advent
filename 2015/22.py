...
def resolve(spell_cast, player_hp, player_mp, enemy_hp, enemy_atk, ongoing=None, hard=False):
    player_turn = spell_cast is not None

    if hard and player_turn:
        player_hp -= 1
        if player_hp < 1: return "loss",
    ...
    return "ongoing", player_hp, player_mp, enemy_hp, enemy_atk, ongoing
...
assert resolve_sequence([10, 250, 13, 8], ['Poison', 'Magic Missile']) == 'win'
assert resolve_sequence([10, 250, 14, 8], ['Recharge','Shield','Drain','Poison','Magic Missile']) == "win"
